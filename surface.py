...
#导入文件
import_button = tkinter.Button(top,text='导入文件',command=import_word).grid(column=2,row=2)
...
# stop_button = tkinter.Button(top,text='暂停听写',command=thread_stop)
